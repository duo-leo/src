...
# Allow parsing evaluation config from command line
import argparse

parser = argparse.ArgumentParser(description="Fairseq Transformer Evaluation Configs")
...
parser.add_argument('--test_file', type=str, default="test.zh-vi.zh", help='Path to test file')
args, unknown = parser.parse_known_args()

EVAL_CHECKPOINT_PATH = args.checkpoint_path
EVAL_DATA_BIN_PATH = args.data_bin_path
